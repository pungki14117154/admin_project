...
import 'Edit_Desainer.dart';
import 'Edit_kontraktor.dart';

class DetailDesainer extends StatefulWidget {
  @override
  _DetailDesainerState createState() => _DetailDesainerState();
}

class _DetailDesainerState extends State<DetailDesainer> {
  String name = 'Admin01';
                      ...
                      Stack(children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                                image: AssetImage(
                                    'assets/mitra/desainer/warna.jpg'),
                                fit: BoxFit.fill),
                          ),
                        ),
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image:
                                    AssetImage('assets/mitra/desainer/de1.jpg'),
                                fit: BoxFit.cover,
                              )),
                        ),
                      ]),
                      ...
                      Column(
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text(
                              'Pengalaman dan keilmuan yang dimiliki oleh para arsitek kami menjamin hasil karya dari proyek-proyek yang telah diselesaiakan. Arch of Art merupakan satu-satunya perusahaan dibidang pembangunan yang dipercaya menjamin hasil tanpa mengecewakan. Segera hubungi kami jika membutuhkan tim yang dapat membuat rumah impian Anda terwujud. \n\n Arch Of Art mewujudkan mimpi Anda !',
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text(
              'Apakah Anda yakin akan menghapus Desainer ?',
              style:
