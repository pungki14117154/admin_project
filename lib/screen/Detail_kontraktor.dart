...
class DetailKontraktor extends StatefulWidget {
  @override
  _DetailKontraktorState createState() => _DetailKontraktorState();
}

class _DetailKontraktorState extends State<DetailKontraktor> {
  String name = 'Admin01';
                      ...
                      Stack(children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: AssetImage(
                                    'assets/mitra/kontraktor/kon3.jpg'),
                                fit: BoxFit.cover,
                              )),
                        ),
                      ]),
                        ...
                        child: Row(
                          children: [
                            ...
                            FlatButton(
                              ...
                              onPressed: () {
                                Route route = MaterialPageRoute(
                                    builder: (context) => EditKontraktor());
                                Navigator.push(context, route);
                              },
                              child: Container(
                                width: 20,
                      ...
                      Column(
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text(
                              'Agung Perkasa, Perusahaan Kontraktor yang sudah bergerak sejak tahun 2008. Berlokasi di Jl. Pagar Alam, Lampung Selatan. Proyek yang sudah diselesaikan oleh tim Agung Perkasa mulai dari pembangunan bangunan kecil hingga proyek Tender besar. Proyek pembangunan rumah, jalan raya, jembatan, dll.',
