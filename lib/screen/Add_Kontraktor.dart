...
class TambahKontraktor extends StatefulWidget {
  String get options => null;

  @override
  _TambahKontraktorState createState() => _TambahKontraktorState();
}

class _TambahKontraktorState extends State<TambahKontraktor> {
  String name_layanan = 'REGISTRASI KONTRAKTOR';
  String name = '';
  String username = '';
  String password = '';
  String rePassword = '';
