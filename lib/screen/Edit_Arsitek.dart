...
class EditArsitek extends StatefulWidget {
  @override
  _EditArsitekState createState() => _EditArsitekState();
}

class _EditArsitekState extends State<EditArsitek> {
  String name = '';
  String username = '';
  String password = '';
  String rePassword = '';
