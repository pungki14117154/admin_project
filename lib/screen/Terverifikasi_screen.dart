...
class TerverifikasiScreen extends StatefulWidget {
  @override
  _TerverifikasiScreenState createState() => _TerverifikasiScreenState();
}

class _TerverifikasiScreenState extends State<TerverifikasiScreen> {
  String name = 'Admin01';
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  _judulDaftar('Proyek Terverifikasi'),
                  Container(
                    height: 520,
                    child: ListView(
                      children: [
