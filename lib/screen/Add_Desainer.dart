...
class TambahDesainer extends StatefulWidget {
  String get options => null;

  @override
  _TambahDesainerState createState() => _TambahDesainerState();
}

class _TambahDesainerState extends State<TambahDesainer> {
  String name_layanan = 'REGISTRASI DESAINER';
  String name = '';
  String username = '';
  String password = '';
  String rePassword = '';
