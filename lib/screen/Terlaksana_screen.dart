...
class TerlaksanaScreen extends StatefulWidget {
  @override
  _TerlaksanaScreenState createState() => _TerlaksanaScreenState();
}

class _TerlaksanaScreenState extends State<TerlaksanaScreen> {
  String name = 'Admin01';
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  _judulDaftar('Proyek Terlaksana'),
                  Container(
                    height: 520,
                    child: ListView(
                      children: [
